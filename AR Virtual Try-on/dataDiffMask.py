...
from Common.utils import ReplayBuffer, weights_init_normal, LambdaLR
...
def get_opt():
    ...
    parser.add_argument('load_path_Shape', type=str, default="pre_trained_models/Stage_1/Gan_1.pth",
                        help='load_Shape_model')
    parser.add_argument('load_path_Stitch', type=str, default="pre_trained_models/Stage_2/Gan_5.pth",
                        help='load_Stitch_model')
    parser.add_argument('image_folder', type=str, default='./Data/train/image', help='save all result folder')
...
def diffMask(img1, opt, dataset, netG1, netG2):
    ...
    src1, mask1, style_img1, target1, gt_cloth1, skel1, cloth1 = Variable(src), Variable(mask), Variable(
    ...
    gen_targ_Stitch, s_128, s_64, s_32, s_16, s_8, s_4 = netG2(src1, gen_targ_Shape,
                                                               skel1)  # gen_targ12 is stitch image
    ...
    plt.imsave("./mask3.jpg", np.array(msk1, dtype='uint8'), cmap="gray")
    plt.imsave("./ref3.jpg",
